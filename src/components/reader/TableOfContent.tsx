...
const TableOfContent: FC<Props> = ({ visible, data, onClick }) => {
  return (
    <div
      ...
      className="bg-white dark:bg-[#2B2B2B] text-black dark:text-[#f8f8ea] transition-all md:w-96 w-3/4 h-screen overflow-y-scroll fixed z-50 top-0 right-0 flex flex-col space-y-3 p-3 shadow-md"
    >
